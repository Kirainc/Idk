...
local Tab = Library:Init()

-- สร้าง Tab แรก
local MainTab = Tab:CreateTap("Main", "Main Features", "rbxassetid://6023565895")

-- Section ฝั่งซ้าย
local LeftSection = MainTab:CreatePage("Movement", 1)

LeftSection:AddToggle("Fly", {
    Stats = false,
...
LeftSection:AddSlider("Walk Speed", {
    min = 16,
    max = 500,
    value = 16,
    callback = function(value)
...
LeftSection:AddSlider("Jump Power", {
    min = 50,
    max = 500,
    value = 50,
    callback = function(value)
...
LeftSection:AddButton("Reset Character", function()
    game.Players.LocalPlayer.Character.Humanoid.Health = 0
end)

-- Section ฝั่งขวา
local RightSection = MainTab:CreatePage("Misc", 2)

RightSection:AddLabel("Player Tools")

RightSection:AddDropdown("Team", {
...
RightSection:AddTextBox("Custom Name", {
    Placeholder = "ใส่ชื่อ...",
    callback = function(text)
        game.Players.LocalPlayer.Character.Head.Name = text
    end
})

-- สร้าง Tab ที่สอง
local Tab2 = Tab:CreateTap("Combat", "Combat Features", "rbxassetid://6023565895")
local CombatSection = Tab2:CreatePage("Aimbot", 1)
